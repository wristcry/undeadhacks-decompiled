...
namespace UndeadHacks
{
	...
	{
		// Token: 0x0600026C RID: 620 RVA: 0x00016B0C File Offset: 0x00014D0C
		public static void Tab()
		{
			Prefab.ScrollView(new Rect(0f, 0f, 395f, 406f), <Module>.smethod_6<string>(877676236u), ref StatsTab.ScrollPos, delegate()
			{
			...
			Prefab.MenuArea(new Rect(400f, 0f, 196f, 406f), <Module>.smethod_7<string>(1354188543u), delegate
			{
				...
				GUILayout.Space(4f);
				GUILayout.Label(string.Format(<Module>.smethod_4<string>(2065763410u), num), Prefab._TextStyle, Array.Empty<GUILayoutOption>());
				GUILayout.Space(3f);
				StatsTab.Amount = Prefab.TextField(StatsTab.Amount, <Module>.smethod_8<string>(1884284553u), 50f);
				GUILayout.Space(2f);
				int num2;
				if (int.TryParse(StatsTab.Amount, out num2))
				{
					if (Prefab.Button(<Module>.smethod_5<string>(2930776812u), 75f, 25f))
					{
